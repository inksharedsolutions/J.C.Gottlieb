                        ...
                        <div className="wrapper-bg-left">
                            <div className="left-col">
                                <div className="banner-content-wrapper">
                                    ...
                                    <p>
                                    Iris has gone through five long years of deep depression, with almost no breaks. Finally, she's found a career that gives joy to those suffering from life-threatening illness. Before she can implement her plan, however, she is hit by a car and dies.
                                    </p>
