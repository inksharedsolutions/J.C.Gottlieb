            ...
            <footer className="footer-section">
                <div className="container-gt" id="footer-info">
                    ...
                    <p className="param-footer">
                        J.C. Gottlieb loves to hear from readers. You can reach her via email. 
                    ...
                    <nav>
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/JC-Gottlieb-112699583860231/"
                            ...
                            <li>
                                <a 
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/54628335-for-all-eternity" rel="noreferrer">
                                    <FontAwesomeIcon 
                                        className='font-awesome'
                                        icon={faGoodreads} />
                                </a>
